        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KnownAs = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ...
                    LookingFor = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LikerId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    LikeeId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplacedBy = table.Column<string>(type: "TEXT", maxLength: 90, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Threads_AspNetUsers_RecipientId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    InterestId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Threads_Modified",
                table: "Threads",
                column: "Modified");

            migrationBuilder.CreateIndex(
                name: "IX_Threads_RecipientId",
                table: "Threads",
                column: "RecipientId");
